...
DBM_CORE_RAID_DOWN					= "%s|1을;를; %s만에 모두 끝냈습니다!"
DBM_CORE_RAID_DOWN_L				= "%s|1을;를; %s만에 모두 끝냈습니다! 가장 빠른 완료 기록은 %s 입니다."
DBM_CORE_RAID_DOWN_NR				= "%s|1을;를; %s만에 모두 끝냈습니다! 신기록입니다! (이전 기록은 %s)"
...
DBM_CORE_UPDATEREMINDER_DISABLE			= "경고: 지금 사용중인 "..DBM_DEADLY_BOSS_MODS.."가 지나치게 오래되어 강제로 비활성화되며 업데이트 전까진 사용할 수 없습니다. 이는 오래되고 호환되지 않는 모드가 당신과 파티/공대원의 플레이에 악영향을 미치지 않게 하기 위함입니다."
...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.targetNF		= "$spell:%s 대상 알림 (전역 대상 필터 무시)"
