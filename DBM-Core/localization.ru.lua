...
L.WORLD_BUFFS = {
	hordeOny						= "Народы Орды, жители Оргриммара! Приходите, собирайтесь и поздравляйте героя Орды",
	allianceOny						= "Граждане и союзники Штормграда, в этот день вершилась история.",
	hordeNef						= "НЕФАРИАН УБИТ! Жители Оргриммара",
	allianceNef						= "Граждане Альянса! Владыка Черной горы повержен!",
	zgHeart							= "Теперь остался лишь один шаг до избавления от Свежевателя Душ",
	zgHeartBooty					= "Кровавый Свежеватель Душ побежден! Теперь нам ничто не угрожает!",
	zgHeartYojamba					= "Начинайте ритуал, слуги мои. Мы должны отправить сердце Хаккара обратно в Пустоту!",
	rendHead						= "Самозванец Ренд Чернорук мертв!"
}
