...
DBM = {
	...
	DisplayVersion = "1.13.66 alpha", -- the string that is shown as version
	ReleaseRevision = releaseDate(2021, 1, 6) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
