...
L.RAID_DOWN					= "¡%s limpiado después de %s!"
L.RAID_DOWN_L				= "¡%s limpiado después de %s! Tu limpieza más rápida llevó %s."
L.RAID_DOWN_NR				= "¡%s limpiado después de %s! ¡Es un nuevo récord! (El anterior era %s)"
