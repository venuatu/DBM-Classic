...
L:SetOptionLocalization({
	WarningChargeChanged	= "극성이 바뀔때 특별 경고 보기",
	WarningChargeNotChanged	= "극성이 바뀌지 않으면 특별 경고 보기",
...
L:SetOptionLocalization({
	...
	SpecialWarningMarkOnPlayer	= "징표가 4중첩 이상이 되면 특별 경고 보기"
})
...
L:SetOptionLocalization({
	...
	WarningDeepBreath		= "냉기 숨결 특별 경고 보기"
})
...
L:SetOptionLocalization({
	TimerPhase2			= "2단계 타이머 바 보기",
	specwarnP2Soon		= "켈투자드 전투 개시 10초 전에 특별 경고 보기",
