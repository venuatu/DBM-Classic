...
-- Tab: Raidwarning
L.Tab_RaidWarning 			= "레이드 경고"
L.RaidWarning_Header		= "레이드 경고 설정"
L.RaidWarnColors 			= "레이드 경고 색상"
...
L.ShowWarningsInChat 		= "대화창에서 경고 보기"
...
L.RaidWarnSound				= "레이드 경고에 효과음 재생"
...
-- Tab: Spec Warn Frame
L.Panel_SpecWarnFrame		= "특별 레이드 경고"
L.Area_SpecWarn				= "특별 경고 설정"
L.SpecWarn_ClassColor		= "특별 경고에 직업 색상 사용"
L.ShowSWarningsInChat 		= "대화창에 특별 경고 보기"
L.SWarnNameInNote			= "메모에 내 이름이 있으면 5번 경고(SW5) 설정 사용"
L.SpecialWarningIcon		= "특별 경고에 아이콘 사용"
L.ShortTextSpellname		= "주문 이름을 짧게 줄여서 사용 (가능할 때만)"
L.SpecWarn_FlashFrameRepeat	= "점멸 %d회 반복"
L.SpecWarn_Font				= "특별 경고 글꼴"
...
L.SpecialWarnHeader4		= "종류 4: 가장 위험한 도망 특별 경고 옵션 설정"
...
L.SWFNever					= "하지 않음"
L.SWFDefaultOnly			= "특별 경고가 기본 효과음만 재생할 때 (사용자 지정 효과음은 계속 재생 허용)"
L.SWFAll					= "특별 경고가 모든 효과음을 사용할 때"
L.SpecWarn_AlwaysVoice		= "모든 음성 경고 재생 (특별 경고를 꺼놔도 재생됩니다. 공대장에게 유용하며 다른 사람에게는 권장하지 않습니다)"
...
L.SpamBlockNoSpecWarnText	= "특별 경고 텍스트 표시 안함"
L.SpamBlockNoSpecWarnFlash	= "특별 경고시 화면 점멸 안함"
L.SpamBlockNoSpecWarnSound	= "특별 경고 효과음 재생 안함 (음성 경고 메뉴에서 설정했다면 음성팩은 계속 작동)"
...
L.StripServerName			= "경고, 타이머, 거리 검사, 정보 창에서 이름에 서버명 제거"
